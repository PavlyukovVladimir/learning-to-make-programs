...
<p><a href="#navigation">Вверх к Содержанию</a></p>
  ...
  <p>Будем считать эквивалентными элементы которые не больше и не меньше друг друга.</p>
  <p>Реализуем функцию быстрой сортировки которая берет случайный элемент списка и разделяет все элементы на три списка в первом все элементы меньше выбранного, во втором все эквивалентные, в третьем все больше, затем соберем их в один список предварительно рекурсивно применив эту функцию к первому и третьему списку.</p>
  <p></p>
  <p></p>
  <p></p>
